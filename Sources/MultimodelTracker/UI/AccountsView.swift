...
struct AccountsView: View {
    ...
    var body: some View {
        ...
        // The content measures itself post-layout and reports every discrete
        // height change (tab switch, account added or removed). The window
        // is transparent, so even a missed shrink degrades invisibly —
        // an oversized window region shows nothing.
